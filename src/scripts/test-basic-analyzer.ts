...
function testBasicAnalyzer() {
  console.log('========================================');
  console.log('BASIC DECK ANALYZER TEST');
  console.log('Testing with a beginner\'s deck...');
  console.log('========================================\n');
  ...
  console.log('\n========================================');
  console.log('This analyzer is perfect for helping');
  console.log('young players understand deck building!');
  console.log('========================================');
}
